define(['./qiat.js'], function (qiatExtension) {
    return qiatExtension({
        ...
        category1: {
            title: 'Type 1',
            hint: ' - 1',
            name: 'NON-REVERSED CATEGORY', //Will appear in the data.
        ...
        category2: {
            title: 'Type 2',
            hint: ' - 2',
            name: 'REVERSED CATEGORY', //Will appear in the data.
            stimuli: [ //Stimuli content as PIP's media objects
               'I don\'t talk a lot',
        ...
        attribute1: {
            ...
            name: 'FALSE',
            stimuli: [
               'I am playing football on the grass',
        ...
        attribute2: {
            ...
            stimuli: [
               'I am completing a computer task',
                ...
                'I am participating in a study on the internet',
